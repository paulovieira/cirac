...
Cirac.mapsMenu = [
    ...
    {
    "groupName": "Índice Simplificado de Vulnerabilidade a Inundação",
    "maps": [
        {
            mapId: "cirac-vul-cp4-sf-pp-75",
            radio: true,
            inputName: "vuln-layers"
        },
        {
            mapId: "cirac-vul-cp4-sf-pp",
            radio: true,
            inputName: "vuln-layers"
        },
...
Cirac.namesMapping = {
    ...
    "cirac_vul_cp4_SF_PP_75": {
        name: "por código postal (percentil 75)",
        group: "Índice Simplificado de Vulnerabilidade a Inundação"
    },
    "cirac_vul_cp4_sf_pp": {
        name: "por código postal (moda)",
        group: "Índice Simplificado de Vulnerabilidade a Inundação"
