...
Cirac.mapsMenu = [
    ...
    {
    "groupName": "Índice de Vulnerabilidade de Precipitação e Susceptibilidade Física (PP+SF)",
    "maps": [
        {
            mapId: "cirac_vul_cp4_sf_pp75",
            radio: true,
            inputName: "vuln-layers"
        },
        {
            mapId: "cirac_vul_cp4_sf_pp",
            radio: true,
            inputName: "vuln-layers"
        },
    ...
    // maps for the case study Alges

    {
    "groupName": "Dano Médio Anual - Algés",
    "maps": [
    
        {
            mapId: "cirac_risk_lx_fixed_assets_i_b",
            radio: true,
            inputName: "risk-layers-alges"
        },
        {
    ...
    {
    "groupName": "Mapas de inundação - Algés",
    "maps": [

        {
            mapId: "cirac_risk_lx_t50",
            radio: true,
            inputName: "flood-layers-alges"
        },
        {
    ...
    // maps for the case study Coimbra

    {
    "groupName": "Dano Médio Anual - Coimbra",
    "maps": [
    
        {
            mapId: "cirac_risk_lx_fixed_assets_i_b",
            radio: true,
            inputName: "risk-layers-coimbra"
        },
        {
            mapId: "cirac_risk_lx_fixed_assets_i_g",
            radio: true,
    ...
    {
    "groupName": "Mapas de inundação - Coimbra",
    "maps": [

        {
            mapId: "cirac_risk_lx_t50",
            radio: true,
            inputName: "flood-layers-coimbra"
        },
        {
            mapId: "cirac_risk_lx_t100",
            radio: true,
    ...
    // maps for the case study Lisboa

    {
    "groupName": "Dano Médio Anual - Lisboa",
    "maps": [
    
        {
            mapId: "cirac_risk_lx_fixed_assets_i_b",
            radio: true,
            inputName: "risk-layers-lisbon"
        },
        {
            mapId: "cirac_risk_lx_fixed_assets_i_g",
            radio: true,
    ...
    {
    "groupName": "Mapas de inundação - Lisboa",
    "maps": [

        {
            mapId: "cirac_risk_lx_t50",
            radio: true,
            inputName: "flood-layers-lisbon"
        },
        {
            mapId: "cirac_risk_lx_t100",
            radio: true,
    ...
    // maps for the case study Porto

    {
    "groupName": "Dano Médio Anual - Porto e Gaia",
    "maps": [
    
        {
            mapId: "cirac_risk_lx_fixed_assets_i_b",
            radio: true,
            inputName: "risk-layers-porto"
        },
        {
            mapId: "cirac_risk_lx_fixed_assets_i_g",
            radio: true,
    ...
    {
    "groupName": "Mapas de inundação - Porto e Gaia",
    "maps": [

        {
            mapId: "cirac_risk_lx_t50",
            radio: true,
            inputName: "flood-layers-porto"
        },
        {
            mapId: "cirac_risk_lx_t100",
            radio: true,
...
Cirac.namesMapping = {
    ...
    "cirac_vul_cp4_sf_pp75": {
        name: "por código postal (percentil 75)",
        group: "Índice de Vulnerabilidade de Precipitação e Susceptibilidade Física"
    },
    "cirac_vul_cp4_sf_pp": {
        name: "por código postal (moda)",
        group: "Índice de Vulnerabilidade de Precipitação e Susceptibilidade Física"
